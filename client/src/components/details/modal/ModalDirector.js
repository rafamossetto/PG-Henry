...
function ModalDirector({ showModalDirector, setShowModalDirector }) {
    ...
    const handleSubmit = async (e) => {
        ...
        await swal(`${'Director'}`, `Edited succesfully`, "success", {
            buttons: false,
            timer: 2000,
        });
    ...
    const animation = useSpring({
        ...
        opacity: showModalDirector ? 1 : 0,
        transform: showModalDirector ? `translateY(0%)` : `translateY(-100%)`
    })
        ...
        <div>
            ...
            <StyledContainer ref={modalRef} onClick={closeModal}>
                ...
                >
                    <button
                        className="close"
                        onClick={() => setShowModalDirector(prev => !prev)}
                    > X
                    </button>

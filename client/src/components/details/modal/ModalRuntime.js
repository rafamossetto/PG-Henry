...
function ModalRuntime({ showModalRuntime, setShowModalRuntime }) {
    ...
    const handleSubmit = async (e) => {
        ...
        await swal(`${'Runtime'}`, `Edited succesfully`, "success", {
            buttons: false,
            timer: 2000,
        });
    ...
    const animation = useSpring({
        ...
        opacity: showModalRuntime ? 1 : 0,
        transform: showModalRuntime ? `translateY(0%)` : `translateY(-100%)`
    })
        ...
        <div>
            ...
            <StyledContainer ref={modalRef} onClick={closeModal}>
                ...
                >
                    <button
                        className="close"
                        onClick={() => setShowModalRuntime(prev => !prev)}
                    > X
                    </button>

...
function ModalRelease({ showModalRelease, setShowModalRelease }) {
    ...
    const handleSubmit = async (e) => {
        ...
        await swal(`${'Release date'}`, `Edited succesfully`, "success", {
            buttons: false,
            timer: 2000,
        });
    ...
    const animation = useSpring({
        ...
        opacity: showModalRelease ? 1 : 0,
        transform: showModalRelease ? `translateY(0%)` : `translateY(-100%)`
    })
        ...
        <div>
            ...
            <StyledContainer ref={modalRef} onClick={closeModal}>
                ...
                >
                    <button
                        className="close"
                        onClick={() => setShowModalRelease(prev => !prev)}
                    > X
                    </button>
